package com.mystikcoder.spotifyclone.ui.fragments
...
import com.mystikcoder.spotifyclone.ui.viewmodel.SongViewModel
...
class SongFragment : Fragment(R.layout.fragment_song) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        seekBar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener{
            ...
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                if (fromUser){
                    setCurrentPlayingTimeToTextView(progress.toLong())
                }
            }
    ...
    private fun subscribeToObservers() {
        ...
        songViewModel.curPlayerPosition.observe(viewLifecycleOwner) {
            if (shouldUpdateSeekBar) {
                ...
                setCurrentPlayingTimeToTextView(it)
            }
        }
    ...
    private fun setCurrentPlayingTimeToTextView(ms: Long?) {
        val dateFormat = SimpleDateFormat("mm:ss", Locale.getDefault())
